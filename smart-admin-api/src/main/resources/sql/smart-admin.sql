...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='部门表';
...
CREATE TABLE IF NOT EXISTS `t_email` (
  ...
  `to_emails` varchar(200)  NOT NULL COMMENT '收件人',
...
CREATE TABLE IF NOT EXISTS `t_employee` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='员工表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='id生成器定义表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='id_generator记录表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='各种单据操作记录\r\n';
...
CREATE TABLE IF NOT EXISTS `t_position` (
  ...
  `create_time` datetime  COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='岗位表';
...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='岗位关联表';
...
CREATE TABLE IF NOT EXISTS `t_privilege` (
  ...
  `key` varchar(200) NOT NULL COMMENT '路由name 英文关键字',
  `url` text COMMENT '路由path/type=3为API接口',
  `sort` int NOT NULL DEFAULT '0' COMMENT '排序',
  `parent_key` varchar(200) DEFAULT NULL COMMENT '父级key',
...
CREATE TABLE IF NOT EXISTS `t_quartz_task` (
  ...
  `task_bean` varchar(50)  NOT NULL COMMENT 'spring bean名称',
  `task_params` varchar(1000)  DEFAULT NULL COMMENT '任务参数',
  `task_cron` varchar(50)  NOT NULL COMMENT '运行cron表达式',
...
CREATE TABLE IF NOT EXISTS `t_quartz_task_log` (
  ...
  `process_log` text  COMMENT '日志',
  `ip_address` varchar(50)  DEFAULT NULL COMMENT '运行主机ip',
  `update_time` datetime   COMMENT '更新时间',
  `create_time` datetime  COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=732881 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `t_role_employee` (
  ...
  `create_time` datetime  COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=214 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='角色员工功能表';
...
CREATE TABLE IF NOT EXISTS `t_role_privilege` (
  ...
  `create_time` datetime  COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10835 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='角色权限功能表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1743 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户登录日志';
